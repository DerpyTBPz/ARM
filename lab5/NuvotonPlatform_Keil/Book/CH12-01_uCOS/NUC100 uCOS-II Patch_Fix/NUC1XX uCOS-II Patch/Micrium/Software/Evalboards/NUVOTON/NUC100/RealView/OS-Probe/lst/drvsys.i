#line 1 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Src\\Driver\\DrvSYS.c"
...
#line 7 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Src\\Driver\\DrvSYS.c"
...
#line 8 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Src\\Driver\\DrvSYS.c"
...
#line 9 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Src\\Driver\\DrvSYS.c"
...
int32_t DrvSYS_UnlockKeyAddr(void)
{
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGLOCK = 0x59;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGLOCK = 0x16;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGLOCK = 0x88;

	lockbit = ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGLOCK & 0x01;
...
int32_t DrvSYS_LockKeyAddr(void)
{
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGLOCK = 0x00;
...
void DrvSYS_EnableBODRst(int32_t i32Enable, BOD_CALLBACK bodcallbackFn)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR.BOD_RSTEN = i32Enable;
...
void DrvSYS_EnableBODLowPowerMode(int32_t i32Enable)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR.BOD_LPM = i32Enable;
}
...
void DrvSYS_EnableLowVoltRst(int32_t i32Enable)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR.LVR_EN = i32Enable;
}
...
void DrvSYS_EnableTempatureSensor(int32_t i32Enable)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR.VTEMP_EN = i32Enable;
}
...
void DrvSYS_SetPORDisCode(uint32_t u32Code)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PORCR = u32Code;
}
...
void DrvSYS_SetRCAdjValue(uint32_t u32Adj)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->RCADJ = u32Adj;
}
...
int32_t DrvSYS_SetIPClockSource(E_SYS_IP_CLKSRC eIpClkSrc, uint8_t u8ClkSrcSel)
{
	...
	switch(eIpClkSrc)
	{
		case E_SYS_PWM32_CLKSRC:  
			((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.PWM32_S = u8ClkSrcSel;
			break;
		case E_SYS_PWM10_CLKSRC:
			((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.PWM10_S = u8ClkSrcSel;
			break;
		case E_SYS_CAN_CLKSRC:
		    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.CAN_S = u8ClkSrcSel;
			break;
		...
		case E_SYS_WDG_CLKSRC:
		    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.WDG_S = u8ClkSrcSel;
			break;				
		default:
...
int32_t DrvSYS_SetClockDivider(E_SYS_IP_DIV eIpDiv , int32_t i32value)
{
	...
	{
	 	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV.CAN_N = i32value;
	}
...
{
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.PD_WU_STS = 0;
...
void DrvSYS_EnablePWRWUInt(int32_t i32Enable, PWRWU_CALLBACK pdwucallbackFn, int32_t i32enWUDelay)
{
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.WINT_EN = i32Enable;
	
	if (i32Enable)
	{		
		((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.WU_DLY = i32enWUDelay;
		PWRWU_callbackFn = pdwucallbackFn;
		NVIC_EnableIRQ(PWRWU_IRQn);
	}
	else
	{ 
		((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.WU_DLY = 0;
		PWRWU_callbackFn = 0;
...
void DrvSYS_EnablePowerDown(int32_t i32Enable)
{
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.PWR_DOWN = i32Enable;
}
...
void DrvSYS_SetPowerDownWaitCPU(int32_t i32Enable)
{
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.PD_WAIT_CPU = i32Enable;
}
...
void DrvSYS_SetPLLPowerDown(int32_t i32Enable)
{
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.PD = i32Enable;
}
...
int32_t DrvSYS_Open(uint32_t u32ExtClockKHz, uint32_t u32PllClockKHz)
{
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.FB_DV  = (u32PllCr & 0x01FF);
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.IN_DV  = (u32PllCr >> 9) & 0x1F;
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.OUT_DV = (u32PllCr >> 14) & 0x03;
