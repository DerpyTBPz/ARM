#line 1 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Sample\\Driver\\Smpl_DrvUART\\Smpl_DrvUART.c"
...
#line 7 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Sample\\Driver\\Smpl_DrvUART\\Smpl_DrvUART.c"
...
#line 8 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Sample\\Driver\\Smpl_DrvUART\\Smpl_DrvUART.c"
...
#line 9 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Sample\\Driver\\Smpl_DrvUART\\Smpl_DrvUART.c"
#line 10 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Sample\\Driver\\Smpl_DrvUART\\Smpl_DrvUART.c"
...
#line 11 "..\\..\\..\\..\\NUC1XX_BSP\\NuvotonPlatform_Keil\\Sample\\Driver\\Smpl_DrvUART\\Smpl_DrvUART.c"
	...
	if(u32IntStatus & 0x00000001)
	{
		...
		while(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR.RDA_IF==1) 
		{
			...
			if(comRbytes < 64)
			{
				...
				comRtail = (comRtail == (64-1)) ? 0 : (comRtail+1);
				comRbytes++;
			}			
		}
		printf("\nTransmission Test:");
	}
	else if(u32IntStatus & 0x00000002)
	{   
		...
		if(comRhead != tmp)
		{
			...
			comRhead = (comRhead == (64-1)) ? 0 : (comRhead+1);
			comRbytes--;
		}
	}
...
int32_t OS_UART_HANDLE(void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;
    ...
    sParam.u8cStopBits 		= 0x0;
    sParam.u8cParity 		= 0x00;
    sParam.u8cRxTriggerLevel= 0x00;
	...
	if(DrvUART_Open(UART_PORT0,&sParam) == 0)
	{
		...
		DrvUART_EnableInt(UART_PORT0, (0x00000004 | 0x00000002 | 0x00000001),UART_INT_HANDLE);
		
		while(g_bWait);	
		
		
		 
		DrvUART_DisableInt(UART_PORT0,0x00000004 | 0x00000002 | 0x00000001);
