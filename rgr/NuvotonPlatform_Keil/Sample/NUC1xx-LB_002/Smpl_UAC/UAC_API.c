...
static void WAU8822_Setup(void)
{
	...
	I2C_WriteWAU8822(4,  0x012);   /* 16-bit word length, I2S format, Stereo */			
	...
	I2C_WriteWAU8822(15, 0x0EF);   /* ADC left digital volume control */
	I2C_WriteWAU8822(16, 0x1EF);   /* ADC right digital volume control */
		
	I2C_WriteWAU8822(43, 0x010);   

	I2C_WriteWAU8822(44, 0x003);   /* LLIN/RLIN is not connected to PGA */
	I2C_WriteWAU8822(45, 0x03F);   /* Left input PGA Gain value */
	I2C_WriteWAU8822(46, 0x13F);   /* Right input PGA Gain value */
	I2C_WriteWAU8822(47, 0x107);   /* LLIN Gain, and AUXIN Gain value */
	I2C_WriteWAU8822(48, 0x107);   /* RLIN Gain, and AUXIN Gain value */
