...
__align(4) const S_DRVUSB_STRING_DESC
g_sVendorStringDesc =
{
	16,
	DESC_STRING,
...
//keyboard 101keys
const __align(4) uint8_t g_HID_au8KeyboardReportDescriptor[] = {
      0x05, 0x01,
      0x09, 0x06,
      0xA1, 0x01,
      0x05, 0x07,
...
const __align(4) uint8_t g_HID_au8DigitizerReportDescriptor[] = {
...
__align(4) const uint8_t g_HID_au8DeviceDescriptor[] =
{
	LEN_DEVICE,		// bLength
...
__align(4) const uint8_t g_HID_au8ConfigDescriptor[] =
{
	LEN_CONFIG,		// bLength
...
__align(4) const S_DRVUSB_STRING_DESC g_HID_sVendorStringDesc =
{
	16,
	DESC_STRING,
	{'N', 'U', 'V', 'O', 'T', 'O', 'N'}
...
__align(4) const S_DRVUSB_STRING_DESC g_HID_sProductStringDesc =
{
	16,
	DESC_STRING,
	{'W', 'P', 'M', ' ', 'U', 'S', 'B'}
