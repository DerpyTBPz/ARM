...
int32_t DrvGPIO_InitFunction(DRVGPIO_FUNC function)
{
	...
	switch(function)
	{
		...
		case FUNC_TMR1:
		{
			...
			SYS->ALTMFP.PB11_PWM4   =0;	
		}break;

		case FUNC_TMR2:
		{
			SYS->GPBMFP.TM2_SS01 	=1;	
			SYS->ALTMFP.PB10_S01    =0;	
		...
		case FUNC_I2S:	
		{
			...
			SYS->ALTMFP.PC0_I2SLRCLK 		=1;
			SYS->ALTMFP.PC1_I2SBCLK 		=1;
			SYS->ALTMFP.PC2_I2SDI 			=1;
			SYS->ALTMFP.PC3_I2SDO 			=1;
			SYS->ALTMFP.PA15_I2SMCLK		=1;
