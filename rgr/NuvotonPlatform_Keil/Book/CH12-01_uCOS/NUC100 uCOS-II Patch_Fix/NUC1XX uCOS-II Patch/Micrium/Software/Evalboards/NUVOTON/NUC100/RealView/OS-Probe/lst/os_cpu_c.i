#line 1 "..\\..\\..\\..\\..\\uCOS-II\\Ports\\ARM-Cortex-M0\\RealView\\os_cpu_c.c"
...
#line 27 "..\\..\\..\\..\\..\\uCOS-II\\Ports\\ARM-Cortex-M0\\RealView\\os_cpu_c.c"
...
void  OSInitHookBegin (void)
{
    ...
    OS_CPU_ExceptStkBase = &OS_CPU_ExceptStk[128 - 1];
...
INT32U  OS_CPU_ExceptStkChk (void)
{
    ...
    while ((*pchk++ == (OS_STK)0) && (size > 0)) {     
        nfree++;
        size--;
    }
#line 349 "..\\..\\..\\..\\..\\uCOS-II\\Ports\\ARM-Cortex-M0\\RealView\\os_cpu_c.c"
    return (nfree);
}
